...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        <!-- Error Code -->
        <div class="text-9xl font-bold text-blue-500 mb-4">
            404
        </div>
        ...
        <!-- Search Suggestions -->
        <div class="mt-8">
            <h3 class="text-lg font-medium text-gray-900 mb-4">Mungkin Anda mencari:</h3>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Tips:</strong> Periksa kembali URL yang Anda masukkan atau gunakan menu navigasi untuk menemukan halaman yang Anda cari.
                    </p>
                </div>
            </div>
        </div>
