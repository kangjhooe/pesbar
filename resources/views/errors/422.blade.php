...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8">
            ...
            Silakan periksa kembali informasi yang Anda berikan dan coba lagi.
        </p>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-800">
                        <strong>Tips:</strong> Pastikan semua field yang wajib diisi sudah terisi dengan benar. 
                        Periksa format email, panjang password, dan data lainnya.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-blue-800">
                        <strong>Panduan:</strong> Email harus valid, password minimal 6 karakter, 
                        dan pastikan tidak ada field yang kosong.
                    </p>
                </div>
            </div>
        </div>
