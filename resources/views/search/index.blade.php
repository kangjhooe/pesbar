...
@section('title', 'Hasil Pencarian: ' . $query . ' - Portal Berita Kabupaten Pesisir Barat')
@section('description', 'Hasil pencarian untuk: ' . $query . '. Temukan berita terkini dan terpercaya dari Kabupaten Pesisir Barat.')
...
<div class="container mx-auto px-4 py-8">
    ...
    <!-- Search Header -->
    <div class="mb-8">
        <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Hasil Pencarian</h1>
        <p class="text-gray-600 text-lg">
            Menampilkan hasil untuk: <span class="font-semibold text-primary-600">"{{ $query }}"</span>
        </p>
        <p class="text-gray-500 text-sm mt-2">{{ $articles->total() }} artikel ditemukan</p>
    </div>
                        ...
                        <div class="p-6">
                            ...
                            <div class="mb-3">
                                <a href="{{ route('categories.show', $article->category) }}" 
                                   class="inline-block bg-primary-100 text-primary-800 text-xs font-medium px-2 py-1 rounded-full hover:bg-primary-200 transition-colors">
            ...
            @else
                ...
                <div class="bg-white rounded-lg shadow-lg p-12 text-center">
                    ...
                    <p class="text-gray-500 mb-6">
                        Maaf, tidak ada artikel yang ditemukan untuk pencarian <span class="font-semibold">"{{ $query }}"</span>.
                    </p>
                    <div class="space-y-3">
                        <p class="text-sm text-gray-600">Coba dengan kata kunci lain atau:</p>
                        <div class="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <a href="{{ route('home') }}" 
                               class="inline-flex items-center space-x-2 bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                ...
                <form action="{{ route('search.index') }}" method="GET" class="space-y-3">
                    ...
                    <button type="submit" 
                            class="w-full bg-primary-600 text-white font-semibold py-2 rounded-lg hover:bg-primary-700 transition-colors">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                <h3 class="text-xl font-bold text-gray-900 mb-4">Kategori Berita</h3>
                <ul class="space-y-2">
